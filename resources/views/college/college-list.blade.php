                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap" id="college_table">
                                <thead>
                                    <tr>
  ...
  <script src="{{ asset('js/sweetalerts.js') }}"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          let table =  new DataTable('#college_table',{
              paging: true,
              searching: true,
              info: true,
              lengthChange: true,
              ...
              serverSide: true,
              language: {
                searchPlaceholder: "Find College By Name or Code"
              },
              ajax:{
               url: "{{ URL::to('/college-list') }}",
              },
              columns:[
               {
                data: 'id',
