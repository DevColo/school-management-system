                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div style="display: flex;" class="">
                                <a class="btn btn-lg btn-primary" href="{{ URL::to('admin-print-enrolled-students/'.$enrollmentId) }}" target="_blank" title="Print"><i
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          let table =  new DataTable('#course_table',{
              ...
              ajax:{
               url: "{{ URL::to('/enrolled-students/'.$enrollmentId) }}",
              },
              columns:[
               {
                data: 'student_id',
